  ...
  constructor() {
    super("cinq");
          ...
          create (){
            ...
            principale = this.add.image(-650,300, "principale");



            collisionL = this.physics.add.image(-1750,300, "collisionL");
            collisionL.visible = false;
            collisionR = this.physics.add.image(450,300, "collisionR");
            collisionR.visible = false;
            collisionD = this.physics.add.image(-550,1200, "collisionD");
            collisionD.visible = false;
            collisionU = this.physics.add.image(-550,-400, "collisionU");
            collisionU.visible = false;

            collisionPorteH = this.physics.add.image(-650,-375, "collisionPorte");
            collisionPorteH.visible = false;
            collisionPorteB = this.physics.add.image(-650,1175, "collisionPorte");
            collisionPorteB.visible = false;
            collisionPorteD = this.physics.add.image(425,300, "collisionPorte");
            collisionPorteD.visible = false;
            collisionPorteG = this.physics.add.image(-1725,300, "collisionPorte");
            collisionPorteG.visible = false;


            prisonierH = this.physics.add.image(-525,-325, "prisonier");
            prisonierB = this.physics.add.image(-500,1100, "prisonier");
            prisonierD = this.physics.add.image(375,175, "prisonier");
            prisonierG = this.physics.add.image(-1700,200, "prisonier");

            echelle = this.physics.add.image(-650,350, "echelle");
            ...
            this.porteTextG = this.add.text(400,500, 'Entrer [F]', { fontSize: '25px', fill: 'red' });
            this.porteTextG.setOrigin(0.5);
            this.porteTextG.visible = false;

            this.porteTextD = this.add.text(400,500, 'Face aux Ennemies: Attaque [ESPACE] + Direction', { fontSize: '25px', fill: 'red' });
