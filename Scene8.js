  ...
  constructor() {
    super("huit");
              ...
              create (){
                ...
                principale = this.add.image(1450,300, "principale");



                collisionL = this.physics.add.image(350,300, "collisionL");
                collisionL.visible = false;
                collisionR = this.physics.add.image(2550,300, "collisionR");
                collisionR.visible = false;
                collisionD = this.physics.add.image(1550,1200, "collisionD");
                collisionD.visible = false;
                collisionU = this.physics.add.image(1550,-400, "collisionU");
                collisionU.visible = false;

                collisionPorteH = this.physics.add.image(1450,-375, "collisionPorte");
                collisionPorteH.visible = false;
                collisionPorteB = this.physics.add.image(1450,1175, "collisionPorte");
                collisionPorteB.visible = false;
                collisionPorteD = this.physics.add.image(2525,300, "collisionPorte");
                collisionPorteD.visible = false;
                collisionPorteG = this.physics.add.image(375,300, "collisionPorte");
                collisionPorteG.visible = false;


                prisonierH = this.physics.add.image(1575,-325, "prisonier");
                prisonierB = this.physics.add.image(1600,1100, "prisonier");
                prisonierD = this.physics.add.image(2475,175, "prisonier");
                prisonierG = this.physics.add.image(400,200, "prisonier");

                echelle = this.physics.add.image(1450,350, "echelle");
                ...
                this.porteTextH = this.add.text(400,500, 'Entrer [F]', { fontSize: '25px', fill: 'red' });
