  ...
  constructor() {
    super("six");
                  ...
                  create (){
                    ...
                    principale = this.add.image(400,950, "principale");
                    ...
                    collisionD = this.physics.add.image(500,12850, "collisionD");
                    ...
                    collisionPorteB = this.physics.add.image(400,1825, "collisionPorte");
                    collisionPorteB.visible = false;
                    collisionPorteD = this.physics.add.image(475,950, "collisionPorte");
                    collisionPorteD.visible = false;
                    collisionPorteG = this.physics.add.image(-675,950, "collisionPorte");
                    collisionPorteG.visible = false;


                    prisonierH = this.physics.add.image(525,325, "prisonier");
                    prisonierB = this.physics.add.image(550,1750, "prisonier");
                    prisonierD = this.physics.add.image(1425,825, "prisonier");
                    prisonierG = this.physics.add.image(-650,850, "prisonier");

                    echelle = this.physics.add.image(400,1000, "echelle");
                    ...
                    this.porteTextH = this.add.text(400,500, '', { fontSize: '25px', fill: 'red' });
                    ...
                    this.porteTextG = this.add.text(400,500, 'Vous êtes plus courageux', { fontSize: '25px', fill: 'red' });
                    this.porteTextG.setOrigin(0.5);
                    this.porteTextG.visible = false;

                    this.porteTextD = this.add.text(400,500, '', { fontSize: '25px', fill: 'red' });
                    this.porteTextD.setOrigin(0.5);
                    this.porteTextD.visible = false;

                    this.prisonierTextD = this.add.text(400,400, 'Est ce que tous va bien ? Tu sembles contractés cette atrocité', { fontSize: '13px', fill: 'red' });
                    ...
                    this.echelleText = this.add.text(400,500, 'Ouvrir la trappe [F]', { fontSize: '11scorepx', fill: 'red' });
                    ...
                    this.physics.add.overlap(player, missileJ, this.tirJ, null, this);
                  ...
                  porteGauche (player, collisionPorteG){
                    ...
                    else if (cursors.down.isDown || cursors.up.isDown || cursors.right.isDown){
                      this.porteTextG.visible = false;
                    }
                  ...
                  echelleSorti (player, echelle){
                    ...
                    }else if (pressF.isDown){
                      this.echelleText.setText('"Quoi ?!Toujours bloqué ?? On ne peux donc l ouvrir que de l exterieur... Il va donc valloir que je patiente pour le pire.');
                    }
